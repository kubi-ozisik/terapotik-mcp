...
import type { ChatVote } from '@prisma/client';
...
import { Conversation, ConversationContent, ConversationScrollButton } from '@/features/chat/components/elements/conversation';
